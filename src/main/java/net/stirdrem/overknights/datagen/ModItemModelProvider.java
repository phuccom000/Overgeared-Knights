...
import net.stirdrem.overknights.OverKnights;
...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, OverKnights.MOD_ID, existingFileHelper);
    }

    @Override
    protected void registerModels() {
        simpleItem(OverKnights.CHAINMAIL_MESH);
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = OverKnights.MOD_ID; // Change this to your mod id
    ...
    private void trimmedArmorItemWithOverlay(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = OverKnights.MOD_ID;
    ...
    private ItemModelBuilder simpleItem(RegistryObject<Item> item) {
        return withExistingParent(item.getId().getPath(),
                ...
                ResourceLocation.tryBuild(OverKnights.MOD_ID, "item/" + item.getId().getPath()));
    }
    ...
    public void evenSimplerBlockItem(RegistryObject<Block> block) {
        this.withExistingParent(OverKnights.MOD_ID + ":" + ForgeRegistries.BLOCKS.getKey(block.get()).getPath(),
    ...
    public void fenceItem(RegistryObject<Block> block, RegistryObject<Block> baseBlock) {
        this.withExistingParent(ForgeRegistries.BLOCKS.getKey(block.get()).getPath(), mcLoc("block/fence_inventory"))
                .texture("texture", ResourceLocation.tryBuild(OverKnights.MOD_ID, "block/" + ForgeRegistries.BLOCKS.getKey(baseBlock.get()).getPath()));
    }
    ...
    public void wallItem(RegistryObject<Block> block, RegistryObject<Block> baseBlock) {
        this.withExistingParent(ForgeRegistries.BLOCKS.getKey(block.get()).getPath(), mcLoc("block/wall_inventory"))
                .texture("wall", ResourceLocation.tryBuild(OverKnights.MOD_ID, "block/" + ForgeRegistries.BLOCKS.getKey(baseBlock.get()).getPath()));
    }
    ...
    private ItemModelBuilder simpleBlockItemBlockTexture(RegistryObject<Block> item) {
        return withExistingParent(item.getId().getPath(),
                ResourceLocation.tryParse("item/generated")).texture("layer0",
                ResourceLocation.tryBuild(OverKnights.MOD_ID, "block/" + item.getId().getPath()));
    }
    ...
    private void upgradeArrowModel(RegistryObject<Item> item) {
        ...
        getBuilder(baseName)
                ...
                .override()
                .predicate(new ResourceLocation("overknights", "potion_type"), 1f)
                .model(new ModelFile.UncheckedModelFile(modLoc("item/" + baseName + "_tipped")))
                .end()
                .override()
                .predicate(new ResourceLocation("overknights", "potion_type"), 2f)
